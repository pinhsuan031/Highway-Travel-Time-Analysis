...
api.add_resource(TravelTimeResource, "/travel-time", resource_class_kwargs={"spark": get_spark()})
#api.add_resource(TravelTimeResource, "/travel-time", resource_class_kwargs={"spark": None})
